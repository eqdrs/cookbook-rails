...
feature 'Visitor visit homepage' do
  ...
  scenario 'and view six last recipes' do
    ...
    recipe_type = RecipeType.create(name: 'Sobremesa')
    cuisine = Cuisine.create(name: 'Brasileira')
    carrot_cake = Recipe.create!(title: 'Bolo de cenoura',
                                 recipe_type: recipe_type,
                                 cuisine: cuisine, difficulty: 'Médio',
                                 cook_time: 60,
                                 ingredients: 'Farinha, açucar, cenoura',
                                 cook_method: 'Cozinhe a cenoura, corte em '\
                                              'pedaços pequenos, misture com '\
                                              'o restante dos ingredientes',
                                 user: user)
    orange_cake = Recipe.create!(title: 'Bolo de laranja',
                                 recipe_type: recipe_type,
                                 cuisine: cuisine, difficulty: 'Médio',
                                 cook_time: 60,
                                 ...
                                 user: user)
    strawberry_cake = Recipe.create!(title: 'Bolo de morango',
                                     recipe_type: recipe_type,
                                     cuisine: cuisine, difficulty: 'Médio',
                                     cook_time: 60,
                                     ...
                                     cook_method: 'Misture e coloque no forno.',
                                     user: user)
    blueberry_cake = Recipe.create!(title: 'Bolo de mirtilo',
                                    recipe_type: recipe_type,
                                    cuisine: cuisine, difficulty: 'Médio',
                                    cook_time: 60,
                                    ...
                                    cook_method: 'Misture e coloque no forno.',
                                    user: user)
    chocolate_cake = Recipe.create!(title: 'Bolo de chocolate',
                                    recipe_type: recipe_type,
                                    cuisine: cuisine, difficulty: 'Médio',
                                    cook_time: 60,
                                    ...
                                    cook_method: 'Misture e coloque no forno.',
                                    user: user)
    corn_cake = Recipe.create!(title: 'Bolo de milho',
                               recipe_type: recipe_type,
                               cuisine: cuisine, difficulty: 'Médio',
                               cook_time: 60,
                               ...
                               cook_method: 'Misture e coloque no forno.',
                               user: user)
    banana_cake = Recipe.create!(title: 'Bolo de banana',
                                 recipe_type: recipe_type,
                                 cuisine: cuisine, difficulty: 'Médio',
                                 cook_time: 60,
